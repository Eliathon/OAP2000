...
public class TabbedPaymentPanel extends JFrame {
    ...
    public TabbedPaymentPanel() {
        // Loading the last window position
        ...
        // Adding components to panel1 related to viewing payments.
        ...
        // Creating and adding the 'Back' button and 'Logout' button
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            ...
            frame.setVisible(true); // Displaying the frame, its a toggleable value.
        });
    }
}